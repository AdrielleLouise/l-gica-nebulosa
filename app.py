...
"""O sistema utiliza as 3 regras fornecidas no enunciado e regras complementares foram adicionadas apenas para ampliar a cobertura da simulação interativa e evitar combinações sem classificação.""")
