...
conforto['desconfortavel'] = fuzz.trimf(
    conforto.universe,
    [0, 0, 50])
conforto['moderado'] = fuzz.trimf(
    conforto.universe,
    [30, 50, 70])
conforto['confortavel'] = fuzz.trimf(
    conforto.universe,
    [50, 100, 100])
fig, ax = plt.subplots()
ax.plot(
    conforto.universe,
    conforto['desconfortavel'].mf,
    label='Desconfortável')
ax.plot(
    conforto.universe,
    conforto['moderado'].mf,
    label='Moderado')
ax.plot(
    conforto.universe,
    conforto['confortavel'].mf,
    label='Confortável')
